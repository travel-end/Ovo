...
object PlayQueueManager {
    ...
    fun updatePlayMode():Int {
        ...
        SpUtil.saveValue(Constant.KEY_PLAY_MODE, playingModeId)
    ...
    fun getPlayModeId():Int {
        return SpUtil.getInt(Constant.KEY_PLAY_MODE)
    }
    /**
     * 获取播放模式
     */
    fun getPlayMode(): String {
        return OvoApp.getInstance().getString(playingMode[playingModeId]);
    }
