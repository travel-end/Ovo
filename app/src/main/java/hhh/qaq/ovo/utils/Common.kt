...
fun Int.getDrawable()=ActivityCompat.getDrawable(OvoApp.getInstance(),this)

fun Int.getResString() = OvoApp.getInstance().resources.getString(this)
...
fun CharSequence.toast(duration: Int = Toast.LENGTH_SHORT) {
    if (this.isNotEmpty()) {
        Toast.makeText(OvoApp.getInstance(), this, duration).show()
    }
}
