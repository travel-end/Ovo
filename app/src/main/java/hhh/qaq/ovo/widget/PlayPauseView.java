...
import hhh.qaq.ovo.utils.JavaUtil;
...
public class PlayPauseView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mGapWidth = JavaUtil.dp2px(context, ta.getDimension(R.styleable.PlayPauseView_gap_width, 0));
        mBorderWidth = JavaUtil.dp2px(context, ta.getDimension(R.styleable.PlayPauseView_border_width, 2));
